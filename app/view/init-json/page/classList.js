const content = {
  pageType: "jh-page", pageId: "classList", table: "class", pageName: "班级列表", template: "jhTemplateV4", version: 'v2',
  resourceList: [
    {
  ...
  headContent: [
    { tag: 'jh-page-title', value: "班级列表", attrs: { cols: 12, sm: 6, md:4 }, helpBtn: true, slot: [] },
