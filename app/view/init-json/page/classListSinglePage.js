const content = {
  pageType: "jh-page", pageId: "classListSinglePage", table: "class", pageName: "班级页面高级使用", template: "jhTemplateV4", version: 'v2',
  resourceList: [
    {
  ...
  headContent: [
    { tag: 'jh-page-title', value: "班级", attrs: { cols: 12, sm: 6, md:4 }, helpBtn: true, slot: [] },
  ...
  pageContent: [
    {
      ...
      rowActionList: [
        // 简写支持 pc 和 移动端折叠
        { text: '学生', icon: 'mdi-note-edit-outline', color: 'success', click: 'updateDrawerTab = 1; doUiAction("startUpdateItem", item)' },
  ...
  actionContent: [
    ...
    },
    {
      ...
      contentList: [
        ...
        { label: "学生", type: "component", componentPath: "studentList", attrs: { ":classId": "updateItem.classId", class: "px-4" } }
      ]
    }
  ],
  includeList: [
